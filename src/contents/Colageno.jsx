                ...
                <div className="px-5 pt-5 bg-collagen">
                    <div className="pt-5 px-5 pb-5 row">
                        <div className='col-sm-6 pt-5 px-5'>
                            <img src={img1} alt="Colageno 1" width="100%" />
                        </div>
                    ...
                    <div className="px-5">
                        ...
                        <div className="row">
                            <div className="col-sm-6 mb-3 mb-sm-0">
                                <div className="card">
                                    <img src={img2} alt="Colageno" width="100%" />
                                    <div className="card-body">
                                        <h5 className="card-title">BELLEZA:</h5>
                                        <p className="card-text"><ul>
                            ...
                            <div className="col-sm-6">
                                <div className="card">
                                    <img src={img3} alt="Colageno" width="100%" />
                                    <div className="card-body">
                                        <h5 className="card-title">ARTICULACIONES:</h5>
                                        <p className="card-text">   <ul>
                        ...
                        <div className="row mt-5">
                            <div className="col-sm-6 mb-3 mb-sm-0">
                                <div className="card">
                                    <img src={img4} alt="Colageno" width="100%" />
                                    <div className="card-body">
                                        <h5 className="card-title">HUESOS:</h5>
                                        <p className="card-text">    <ul>
                            ...
                            <div className="col-sm-6">
                                <div className="card">
                                    <img src={img5} alt="Colageno" width="100%" />
                                    <div className="card-body">
